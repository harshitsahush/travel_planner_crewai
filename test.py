...
task1 = Task(
    ...
    """,
    agent=marketer,
    expected_output = "A report with atleast 10 bullet points on the most important areas to market this business."
)
...
task2 = Task(
    description="""Analyze how to produce plugs for crocs (shoes) so that this iconic footware looks less like swiss cheese.. Write a detailed report 
		with description of which technologies the business needs to use in order to make High Quality plugs for crocs. The report has to be concise with 
    ...
    """,
    agent=technologist,
    expected_output = "A report with atleast 10 bullet points on the technologies required to manufacture it."
)
...
task3 = Task(
    ...
    expected_output = "A report with detailed business plan of how to make a sustainable and profitable business out of it."
)
